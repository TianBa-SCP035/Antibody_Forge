  ...
  <div class="createPost-main-container" v-loading="loading">
      ...
      <template #header>
        <div class="clearfix">
          ...
          <div style="float: right;">
              ...
              <el-button size="small" type="primary" @click="submitForm" @contextmenu.prevent="submitForm($event, true)" :loading="loading" :disabled="loading">保存</el-button>
          ...
          <el-col :span="8">
            <el-form-item label="课题类型" prop="study_type">
              <el-select v-model="postForm.study_type" style="width:100%" filterable allow-create default-first-option placeholder="选择或输入课题类型">
                ...
                <el-option label="我也布吉岛" value="我也布吉岛耶" />
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
    ...
    <el-card v-if="postForm.id" class="box-card danger-zone-card" :body-style="{ padding: '20px' }">
      ...
      <div class="danger-zone-content">
        ...
        <el-button type="danger" size="small" @click="handleDelete" plain>
