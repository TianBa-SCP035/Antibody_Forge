            ...
            <el-card shadow="never" class="table-card full-height">
              <template #header>
                <div class="card-header space-between">
                  ...
                  <el-button type="text" class="add-btn" @click="handleAddTarget">+ 新增</el-button>
                </div>
              </template>
              <el-table :data="titer_targets" size="small" border class="refined-table" style="width: 100%">
                ...
                <el-table-column label="操作" width="50px" align="center">
                  <template #default="scope">
                    <el-button type="text" class="danger-text" @click="handleDeleteTarget(scope.$index)">
            ...
            <el-card shadow="never" class="table-card full-height">
              <template #header>
                <div class="card-header space-between">
                  ...
                  <el-button type="text" class="add-btn" @click="handleAddPc">+ 新增</el-button>
                </div>
              </template>
              <el-table :data="titer_pcs" size="small" border class="refined-table" style="width: 100%">
                ...
                <el-table-column label="操作" width="50px" align="center">
                  <template #default="scope">
                     <el-button type="text" class="danger-text" @click="handleDeletePc(scope.$index)">
                       <el-icon><Delete /></el-icon>
                     </el-button>
                  </template>
                </el-table-column>
      ...
      <div class="facs-plate-section" style="margin-top: 16px;">
        <div class="section-header">
          ...
          <div class="header-buttons">
            <el-button type="primary" class="plate-create-btn" @click="handleAddPlate">
          ...
          <div class="action-section">
            ...
            <el-form label-position="top">
              ...
              <div class="button-group">
                ...
                <el-button type="danger" plain @click="handleDeleteFile(currentFile)">
                  <el-icon><Delete /></el-icon>
                  <span>删除文件</span>
                </el-button>
              </div>
...
export default {
  ...
  computed: {
    currentUserName() {
      return this.userStore.userInfo?.realName || this.userStore.userInfo?.username || 'unknown'
    },
    immuneStageOptions() {
