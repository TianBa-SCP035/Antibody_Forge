          ...
          <div class="form-section basic-info-section">
            ...
            <el-form label-width="80px" class="plate-form">
              <el-form-item label="二维码编号">
                <el-input v-model="plateData.qr_code" placeholder="扫描或输入二维码" @change="autoSave" />
              </el-form-item>
              <el-form-item label="免疫阶段">
                <el-select v-model="plateData.immune_stage" placeholder="请选择免疫阶段" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('immune_stage')">
                  <el-option
              ...
              <el-form-item label="细胞标靶">
                <el-select v-model="plateData.cell_target_id" placeholder="请选择细胞标靶" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('cell_target_id')">
                  <el-option
              ...
              <el-form-item label="横坐标参数">
                <el-input v-model="plateData.x_axis" placeholder="如：SSC-H" @change="autoSave" />
              </el-form-item>
              <el-form-item label="纵坐标参数">
                <el-input v-model="plateData.y_axis" placeholder="如：RL1-H" @change="autoSave" />
              </el-form-item>
              <el-form-item label="上半PC">
                <el-select v-model="plateData.pc_upper_id" placeholder="请选择上PC" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('pc_upper_id')">
                  <el-option
              ...
              <el-form-item label="下半PC">
                <el-select v-model="plateData.pc_lower_id" placeholder="请选择下PC" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('pc_lower_id')">
                  <el-option
                    v-for="pc in pcOptions"
                    :key="pc.id"
                    :label="pc.pc_name"
              ...
              <el-form-item label="上半组别">
                <el-select v-model="plateData.upper_group" placeholder="请选择上半组别" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('upper_group')">
                  <el-option
              ...
              <el-form-item label="下半组别">
                <el-select v-model="plateData.lower_group" placeholder="请选择下半组别" clearable style="width: 100%" @change="autoSave" @clear="onClearFile('lower_group')">
                  <el-option
                    v-for="group in groupOptions"
                    :key="group"
                    :label="group"
          ...
          <div class="image-section">
            <div class="section-title">
              ...
              <div class="header-right">
                <el-button type="text" class="delete-btn" @click="handleDelete">
                  <el-icon><Delete /></el-icon>
                  <span>删除此板</span>
                </el-button>
                <el-button type="text" class="mask-toggle-btn" @click="handleMaskToggle" @contextmenu.prevent.stop="handleMaskContextMenu">
            ...
            <div class="image-display">
              <div class="wells-row top-wells">
                ...
                >
                  <el-input
                    :ref="'top-' + i"
                    :value="plateData.upper_mouse_list[i - 1]"
                    size="small"
                ...
                <div v-if="showMaskAdjuster" class="mask-adjuster">
                  ...
                  <div class="adjuster-content">
                    <div class="adjuster-row">
                        <span>上:</span>
                        <el-input-number v-model="maskOffset.top" :min="0" :max="50" :step="0.1" size="small" controls-position="right" @change="updateGridBBox(false)" />
                        <span>下:</span>
                        <el-input-number v-model="maskOffset.bottom" :min="0" :max="50" :step="0.1" size="small" controls-position="right" @change="updateGridBBox(false)" />
                      </div>
                      <div class="adjuster-row">
                        <span>左:</span>
                        <el-input-number v-model="maskOffset.left" :min="0" :max="50" :step="0.1" size="small" controls-position="right" @change="updateGridBBox(false)" />
                        <span>右:</span>
                        <el-input-number v-model="maskOffset.right" :min="0" :max="50" :step="0.1" size="small" controls-position="right" @change="updateGridBBox(false)" />
                      </div>
                    <div class="adjuster-presets">
                      <span class="preset-label">快速选项:</span>
                      <el-button size="small" @click="setInstrument('国产')">国产</el-button>
                      <el-button size="small" @click="setInstrument('赛多利斯')">赛多利斯</el-button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="wells-row bottom-wells">
                ...
                >
                  <el-input
                    :ref="'bottom-' + i"
                    :value="plateData.lower_mouse_list[i - 1]"
                    size="small"
