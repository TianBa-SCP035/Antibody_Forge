...
PERMISSION_MESSAGES: dict[str, str] = {
    ...
    "serum.titer_order.create": "没有权限新建效价工单",
    "serum.titer_order.batch.edit": "没有权限编辑效价工单批次信息",
