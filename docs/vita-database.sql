...
VALUES
  ...
  ('serum.titer_order.record.edit', '编辑效价工单检测记录', 'action', 'serum', 'titer_order', 'record_edit', NULL, 'serum.titer_order.record.edit_button', 'serum.page.titer_order', 325),
  ('serum.titer_order.record.edit_all', '编辑全部效价工单检测记录', 'action', 'serum', 'titer_order', 'record_edit_all', NULL, 'serum.titer_order.record.edit_all_button', 'serum.page.titer_order', 326),
  ('serum.titer_order.summary.edit', '编辑效价小结', 'action', 'serum', 'titer_order', 'summary_edit', NULL, 'serum.titer_order.summary.edit_button', 'serum.page.titer_order', 330),
...
VALUES
  ...
  ('serum.titer_order.batch.edit', 'POST', '/api/serum/titer/order/save', '保存效价工单批次信息'),
  ('serum.titer_order.owner.edit', 'POST', '/api/serum/titer/order/save', '保存效价负责人'),
  ('serum.titer_order.record.edit', 'POST', '/api/serum/titer/order/save', '保存效价工单检测记录'),
  ('serum.titer_order.summary.edit', 'POST', '/api/serum/titer/order/save', '保存效价小结'),
