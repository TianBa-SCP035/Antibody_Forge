...
const detailGroups = computed(() => {
  ...
  return [
    ...
    group('homology', '跨物种同源性', [
      field('是否有同源基因', booleanLabel(target.is_homologous_gene), true),
